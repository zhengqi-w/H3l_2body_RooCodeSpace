...
void CompareLHC26e6MCEfficiency() {
    ...
    const std::string out =
        "/Users/zhengqingwang/alice/run3task/H3l_2body_spectrum/ROOTWorkFlow/Outputs/StandAloneChecks/MCEfficiency_LHC26e6_vs_LHC25g11_NoReweight";

    MCEffCheck(oldMc, compare, twoBody, labels, cenbins, ptbinsforcent,
               ptbins, ctbins, ptbinsforct, ctbinsforpt,
               selection, out, "both",
        "0-80% FT0C, no LHC26e6 reweight",
